            ...
            if (tl.Count > 0)
            {
                while (TouchPanel.IsGestureAvailable)
                {
                    ...
                    if (_menuScene.Enabled)
                    {
                        ...
                        if (index == 3 && gs.GestureType == GestureType.Tap)
                        {
                            hideAllScenes();
                            Exit();
                        }
                        //else if (index == 0 && gs.GestureType == GestureType.Tap)
                        //{
                        ...
                        //    }
                        //}
                        //else if (index == 1 && gs.GestureType == GestureType.Tap)
                        //{
                        //    _menuScene.hide();
                        //    _helpScene.show();
                        //}
                        //else if (index == 2 && gs.GestureType == GestureType.Tap)
                        //{
                        //    _menuScene.hide();
                        //    _aboutScene.show();
                        //}
